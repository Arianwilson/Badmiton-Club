...
//API emoji and label mapping based on Open-Meteo weather codes
  if (weatherCode === 0) 
...
// Theme and font size management with persistence
...
// size controls for font size accessibility
...
// After transition, set height to auto for responsiveness and allow content changes without breaking layout
...
// Build the weather card HTML with current conditions and next few hours forecast
    container.innerHTML = `
...
// This will attempt to open the user's default email client with a new message pre-filled with their enquiry details. The feedback message informs them of this action.
